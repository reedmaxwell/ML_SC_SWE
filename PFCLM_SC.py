...
#preliminaries
os.chdir('/Users/reed/Projects/HydroFrame-ML/PFCLM_SC/output')

# copy CLM files
shutil.copyfile('/Users/reed/Projects/HydroFrame-ML/PFCLM_SC/inputs/drv_clmin.dat', 'drv_clmin.dat')
shutil.copyfile('/Users/reed/Projects/HydroFrame-ML/PFCLM_SC/inputs/drv_vegm.dat', 'drv_vegm.dat')
shutil.copyfile('/Users/reed/Projects/HydroFrame-ML/PFCLM_SC/inputs/drv_vegp.dat', 'drv_vegp.dat')

# Set our Run Name 
PFCLM_SC = Run("PFCLM_SC_LS")
...
# Reset our Run Name 
PFCLM_SC_HS = PFCLM_SC.clone('PFCLM_SC_HS')
#PFCLM_SC_HS.pfset(pfidb_file='/Users/reed/Projects/HydroFrame-ML/PFCLM_SC/output/PFCLM_SC_LS.pfidb')
#PFCLM_SC_HS = Run.from_definition("/Users/reed/Projects/HydroFrame-ML/PFCLM_SC/output/PFCLM_SC_LS.pfidb")
PFCLM_SC_HS.Solver.CLM.MetFileName = 'LocalForcing_HighSWE.txt'

## re run ParFlow for high swe
